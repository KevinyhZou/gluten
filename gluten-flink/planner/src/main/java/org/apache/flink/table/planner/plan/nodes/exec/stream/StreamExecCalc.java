...
public class StreamExecCalc extends CommonExecCalc implements StreamExecNode<RowData> {
  ...
  private SourceTransformation<RowData, ?, ?> pushDownProjectionToTableScan(
    ...
    InternalTypeInfo<RowData> newSourceOutType = null;
    if (sourceOutType != null) {
      ...
      newSourceOutType = InternalTypeInfo.of(pruningSchema);
    }
    if (newSourceOutType != null) {
      transformation.setOutputType(newSourceOutType);
    }
  ...
  public Transformation<RowData> translateToPlanInternal(
    ...
    if (inputTransform instanceof SourceTransformation) {
      inputTransform = pushDownProjectionToTableScan((SourceTransformation) inputTransform);
    }
